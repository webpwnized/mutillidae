...
try{
	...
	$lQueryString = "INSERT INTO youTubeVideos(recordIndetifier, identificationToken, title)
		VALUES
	        ...
	        (203, '1lblqC2Favk', 'How to Create Shortcut for OWASP ZAP (Linux)'),
            ...
            (230, 'a6_TprVx7LE', 'How to Install OWASP ZAP on Ubuntu'),
            (231, 'bPr8yO_3kOg', 'How to install Java on Linux (Debian, Ubuntu, Kali)'),
            (232, 'abqyFbeFIq4', 'How to Install Java on Windows'),
            (233, 'fJYyfZNNk5A', 'How to Install OWASP ZAP on Windows'),
